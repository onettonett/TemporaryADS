...
print("Groups likely EXCLUDED from FRS/LCF:")
...
# Look at standard deviation of inflation within groups
quintile_by_year = inflation[inflation["archetype_name"] == "income_quintile"].copy()
quintile_by_year["archetype_value"] = pd.to_numeric(quintile_by_year["archetype_value"], errors='coerce')
...
for year in sorted(inflation["year"].unique()):
    year_data = inflation[inflation["year"] == year]
...
print("We group people by INCOME QUINTILE (from FRS)")
print()
